...
NODE={'title':'Senior QA Engineer','identifier':{'value':'42'},'description':'Supplier management, 5-7 years.','jobLocation':{'address':{'addressLocality':'Chennai','addressCountry':'IN'}}}
...
class IdentityTests(unittest.TestCase):
    ...
    def test_recommended_role_cannot_replace_evidence(self):
        other={**NODE,'title':'Test automation Manager','validThrough':'2020-01-01','baseSalary':{'currency':'INR','value':{'value':500000,'unitText':'YEAR'}}}
