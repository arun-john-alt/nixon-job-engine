...
ROW={'url':'https://in.linkedin.com/jobs/view/senior-qa-engineer-at-example-1234567890?trk=search','title':'Example hiring Senior QA Engineer in Chennai, Tamil Nadu, India | LinkedIn','content':'Test automation and supplier management, 5-7 years.'}
...
class LinkedInTests(unittest.TestCase):
    ...
    def test_unscored_indexed_lead(self):
        ...
        self.assertEqual(lead['title'],'Senior QA Engineer')
    ...
    def test_relevance_requires_result_evidence(self):
        for title,content in [('Example hiring QA Engineer',''),('Example hiring QA Engineer in London',''),('Example hiring QA Intern in Chennai',''),('Example hiring Senior QA Engineer in Chennai','15-20 years')]:
