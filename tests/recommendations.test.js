...
import * as engine from '../site/engine.js';import {companyLogo,productCompany} from '../site/companies.js';
...
function app(){const c=vm.createContext({...engine,companyLogo,productCompany,document:{},location:{hostname:'localhost'},setTimeout,clearTimeout});vm.runInContext(code+'\nD=validateDataset('+JSON.stringify(raw)+');',c);return c;}
